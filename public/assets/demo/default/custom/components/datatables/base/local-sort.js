    ...
    init:function() {
        ...
        e=$(".m_datatable").mDatatable( {
            data: {
                ...
                , pageSize:10, serverPaging:!1, serverFiltering:!0, serverSorting:!1
            }
            , layout: {
            ...
            , {
                field:"OrderID", title:"Order ID", filterable:!1, template:"{{OrderID}} - {{ShipCountry}}"
            }
            , {
                field:"TotalPayment", title:"Payment", type:"number", sortCallback:function(t, i, e) {
                    var n=e.field;
                    return $(t).sort(function(t, e) {
                        var a=t[n], l=e[n];
                        return isNaN(parseFloat(a))&&null!=a&&(a=Number(a.replace(/[^0-9\.-]+/g, ""))), isNaN(parseFloat(l))&&null!=a&&(l=Number(l.replace(/[^0-9\.-]+/g, ""))), a=parseFloat(a), l=parseFloat(l), "asc"===i?l<a?1: a<l?-1: 0: a<l?1: l<a?-1: 0
                    }
                    )
                }
            }
            ...
            , {
                field: "PaymentDate", title: "Payment Date", width: 150, type: "date", format: "YYYY-MM-DD HH:mm:ss"
            }
            , {
        ...
        t=e.getDataSourceQuery(),
        $("#m_form_status").on("change", function() {
            var t=e.getDataSourceQuery();
            t.Status=$(this).val().toLowerCase(), e.setDataSourceQuery(t), e.load()
        }
        ).val(void 0!==t.Status?t.Status:""),
        $("#m_form_type").on("change", function() {
            var t=e.getDataSourceQuery();
            t.Type=$(this).val().toLowerCase(), e.setDataSourceQuery(t), e.load()
        }
        ).val(void 0!==t.Type?t.Type:""),
